  ...
  <table class="table table-dark table-borderless">
      ...
      <?php
        ...
        while ($fila = $resultado->fetch(PDO::FETCH_ASSOC)) {
          echo "<tr>";
          echo "<td>"; echo $fila['id_p']; echo "</td>";
          echo "<td>"; echo $fila['Descripcion']; echo "</td>";
     
          if ($tienePermisoEliminar) {
             echo "<td><a href='eliminar_p.php?id_p=".$fila['id_p']."'><button type='button' class='btn btn-danger'>Eliminar</button></a></td>";
          }
          if ($tienePermisoEditar) {
            echo "<td><a href='modif_p.php?id_p=".$fila['id_p']."'><button type='button' class='btn btn-success'>Modificar</button></a></td>";
          }
          echo "</td>";
          echo "</tr>";
        }
